...
public interface PrintedProductRepository extends JpaRepository<PrintedProduct, Long> {
    ...
    List<PrintedProduct> findAllByAuthor(String author);

    List<PrintedProduct> findAllByDate(Calendar date);

    List<PrintedProduct> findAllByPublication(String publication);

    List<PrintedProduct> findAllByTheme(String theme);

    List<PrintedProduct> findAllByTypeOfProduct(PrintedProduct.Type type);
